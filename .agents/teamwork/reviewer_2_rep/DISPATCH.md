...
You are Reviewer 2 Replacement (Security & Interface Reviewer).
Your working directory is: `c:\xampp\htdocs\GTMS\gtms\.agents\teamwork\reviewer_2_rep`
...
* **Input:**
  ...
  - Prior investigation: `c:\xampp\htdocs\GTMS\gtms\.agents\teamwork\reviewer_2\BRIEFING.md`
...
* **Expected Output:**
  - Write `handoff.md` in your working directory `c:\xampp\htdocs\GTMS\gtms\.agents\teamwork\reviewer_2_rep\handoff.md`.
