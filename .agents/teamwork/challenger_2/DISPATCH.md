...
You are Challenger 2 (Schema & Flow Challenger).
Your working directory is: `c:\xampp\htdocs\GTMS\gtms\.agents\teamwork\challenger_2`
...
* **Expected Output:**
  - Write `handoff.md` in your working directory `c:\xampp\htdocs\GTMS\gtms\.agents\teamwork\challenger_2\handoff.md`.
